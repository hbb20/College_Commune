        ...
        <table border="0" cellspacing="0" cellpadding="0">
            <tbody>
                <tr>
                    ...
                    <td><form name="level1_form" action="j2_f_profile_view.jsp" target="content_holder">
                       <input type="submit"   class="sub_abar_button sub_abar_button_left" value="View Profile"  name="Faculty" /></form></td>

                     <td><form name="level2_form" action="j2_f_profile_edit.jsp" target="content_holder">
