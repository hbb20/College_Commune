...
<!DOCTYPE html>
<html>
    <head><link rel="stylesheet" type="text/css" href="j0_general.css">
        ...
        <table border="0" cellspacing="0" cellpadding="0">
            <tbody>
                <tr>
                    ...
                    <td><form name="level1_form" action="j2_f_canvas_level1.jsp" target="content_holder">
                       <input type="submit"  class="sub_abar_button sub_abar_button_left"  value="1st Year" name="Faculty" /></form></td>

                     <td><form name="level2_form" action="j2_f_canvas_level2.jsp" target="content_holder">
                       <input type="submit"  class="sub_abar_button"  value="2nd Year" name="Faculty" /></form></td>
                       
                     <td><form name="level3_form" action="j2_f_canvas_level3.jsp" target="content_holder">
                       <input type="submit"  class="sub_abar_button"  value="3rd Year"  name="Faculty" /></form></td>
                       
                       
                     <td><form name="level4_form" action="j2_f_canvas_level4.jsp" target="content_holder">
