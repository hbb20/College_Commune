        ...
        <table border="0" cellspacing="0" cellpadding="0">
            <tbody>
                <tr>
                    ...
                    <td width="150px"><form name="level1_form" action="j2_s_profile_view.jsp" target="content_holder">
                       <input type="submit" value="View Profile"  style="<%=style_new_btn%>" name="Faculty" /></form></td>

                     <td  width="150px"><form name="level2_form" action="j2_s_profile_edit.jsp" target="content_holder">
