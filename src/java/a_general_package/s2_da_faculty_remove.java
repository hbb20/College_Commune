 ...
 * @author HARSH BHAKT
 */
public class s2_da_faculty_remove extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String msg="Could not remove faculty";
        try {
            /* TODO output your page here. You may use following sample code. */
      if(fm.remove_faculty(user_name))
            msg="Faculty account of "+user_name+" has been Removed";
        } finally {
