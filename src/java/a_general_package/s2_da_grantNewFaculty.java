...
public class s2_da_grantNewFaculty extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        faculty_model fm=new faculty_model(user_id, "", "", "", "", position, "", "", "", "",dept, "");
        ...
        {
            System.out.println("exception in s2_da_grandNewFaculty  "+ex);
            request.setAttribute("msg","Sorry Some Error Occured");
        }
        finally {
            
            RequestDispatcher rd=request.getRequestDispatcher("j2_da_faculty_newplace.jsp");
